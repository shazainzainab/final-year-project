  ...
  return (
    <div className="travel-form-container">
      <div className="form-card">
        ...
        <p className="form-subtitle">Tell us about your dream vacation and we'll create a personalized recommendation!</p>
              ...
              {['halal', 'veg', 'non-veg'].map(food => (
                <label key={food} className="radio-label">
                  ...
                  <span className="radio-text">
                    {food === 'non-veg' ? 'Non-Vegetarian' : food.charAt(0).toUpperCase() + food.slice(1)}
                  </span>
                </label>
              ))}
            </div>
